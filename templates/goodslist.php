<?php include "templates/include/header.php" ?>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display col-md-12" id="table" class="table">
            <thead>
                <tr>
                    <th>Updated</th>
                    <th>Product Name</th>
        ...
        <p><?php echo $results['totalRows'] ?> product<?php echo ($results['totalRows'] != 1) ? 's' : '' ?> in total.</p>
